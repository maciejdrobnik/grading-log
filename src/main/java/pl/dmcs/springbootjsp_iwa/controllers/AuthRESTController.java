...
public class AuthRESTController {
    ...
    public ResponseEntity<?> authenticateUser(@Valid @RequestBody LoginForm loginRequest) {
        ...
        return ResponseEntity.ok(new JwtResponse(jwt,userDetails.getUsername(), userDetails.getAuthorities(), tempUser.getId(), tempUser.getFirstname(), tempUser.getLastname()));
    }
